...
This can be done by running the command `docker run hello-world` through the command line. If this fails, reinstall docker: [Docker Website](https://www.docker.com/)
